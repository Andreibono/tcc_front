...
class _CompanyScreenState extends State<CompanyScreen> {
  ...
  _submitForm(User user) {
    ...
    List<String> companyNameWithLastWhiteSpace = _searchTextController.text.split("");
    if(companyNameWithLastWhiteSpace[companyNameWithLastWhiteSpace.length -1] == ' ') {
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                //   },
                // ),
                SizedBox(height: avaibleHeight * 0.05,),
                Container(
